      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="p-4 bg-blue-50 rounded-lg">
            <h3 className="font-medium text-blue-900 mb-2">Public Profile URL</h3>
            <div className="flex gap-2">
              <Input value={publicUrl} readOnly />
              <Button variant="outline" size="icon" onClick={handleCopyUrl}>
                <Copy className="w-4 h-4" />
          ...
          <div className="border rounded-lg p-6 bg-slate-50">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                ...
                {dealer.tagline && (
                  <p className="text-slate-600 mb-2">{dealer.tagline}</p>
                )}
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="space-y-3">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span>{dealer.phone || 'Not available'}</span>
                  </div>
                  {dealer.whatsapp && (
                    <div className="flex items-center gap-2">
              ...
              <div className="space-y-3">
                <h3 className="font-medium">Trust Indicators</h3>
                <div className="space-y-2">
            ...
            {dealer.description && (
              <div className="mt-6">
                ...
                <p className="text-slate-600 text-sm">{dealer.description}</p>
              </div>
            )}
          </div>
        </CardContent>
