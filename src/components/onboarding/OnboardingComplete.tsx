...
export default function OnboardingComplete({ onComplete, isLoading }) {
  return (
    <div className="text-center py-8">
      ...
      <h2 className="text-2xl font-bold mb-2 text-slate-900 dark:text-white">Setup Almost Complete!</h2>
      ...
      <Card className="mt-8 text-left">
          <CardContent className="p-6">
              <h3 className="font-semibold mb-3 text-slate-900 dark:text-white">What&apos;s Next?</h3>
