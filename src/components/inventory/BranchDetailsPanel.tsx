...
export default function BranchDetailsPanel({
  ...
  if (!branch) {
    return (
      <motion.div
        ...
        className="w-full max-w-md bg-white/95 backdrop-blur-sm rounded-xl shadow-xl border border-blue-200 p-6"
      >
  ...
  return (
    <motion.div
      initial={{ opacity: 0, x: 20 }}
      animate={{ opacity: 1, x: 0 }}
      className="w-full max-w-md bg-white/95 backdrop-blur-sm rounded-xl shadow-xl border border-blue-200 overflow-hidden"
    >
      {/* Branch Header */}
      ...
      <div className="p-6 pb-4">
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          >
            ...
            <div className="text-2xl font-bold text-blue-900">{branch.vehicle_count}</div>
          ...
          >
            ...
            <div className="text-2xl font-bold text-indigo-900">{branch.team_member_count}</div>
            <div className="text-sm text-indigo-600">Team Members</div>
          </motion.div>
        </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <div className="text-sm font-medium">New vehicle added</div>
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <div className="text-sm font-medium">Team member assigned</div>
