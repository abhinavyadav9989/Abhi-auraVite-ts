...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full px-4 py-4 hidden md:flex md:flex-col bg-gradient-to-br from-slate-50 to-blue-50 dark:from-black dark:to-slate-900 w-[300px] shrink-0 overflow-hidden",
          className
        )}
        animate={{
...
export const SidebarLink = ({
  ...
  return (
    <a
      href={link.href}
      className={cn(
        "flex items-center justify-start gap-2 group/sidebar py-2 px-3 rounded-lg transition-all duration-200 hover:bg-slate-100/80 dark:hover:bg-slate-900/80",
        className
      )}
      onClick={onClick}
      {...props}
