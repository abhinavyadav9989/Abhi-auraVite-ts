...
import { Controller, FormProvider, useFormContext, type ControllerProps, type FieldValues, type Path } from "react-hook-form";
...
const useFormField = () => {
  ...
  const { id } = itemContext || { id: undefined as unknown as string }
